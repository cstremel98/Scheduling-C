...
```c
// Write metric tracking code (50 points total)
void finalize_stats(SCHEDULER_STATS* stats); // 20 points
void mark_start(PROCESS* p, SCHEDULER_STATS* stats, float time_started); // 15 points
void mark_end(PROCESS* p, SCHEDULER_STATS* stats, float time_completed); // 15 points

// Implement these (50 points total)
PROCESS* priority_process_selector(PROCESS_LIST* pl); // 10 points
PROCESS* fifo_process_selector(PROCESS_LIST* pl); // 8 points
PROCESS* rr_process_selector(PROCESS_LIST* pl); // 8 points
PROCESS* sjf_process_selector(PROCESS_LIST* pl); // 8 points
PROCESS* lifo_process_selector(PROCESS_LIST* pl); // 8 points
PROCESS* stcf_process_selector(PROCESS_LIST* pl); // 8 points
```
