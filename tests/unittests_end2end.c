...
Test(RoundRobin, test_2proc_0entry_0entry_rr, .disabled=false) {
  SCHEDULER_STATS* stats = get_empty_stats_block();
  SCHEDULER_PARAMS params = (SCHEDULER_PARAMS) {
    .preemptable = true,
...
Test(RoundRobin, test_2proc_0entry_1entry_rr, .disabled=false) {
  SCHEDULER_STATS* stats = get_empty_stats_block();
  SCHEDULER_PARAMS params = (SCHEDULER_PARAMS) {
    .preemptable = true,
    .time_quantum = 0.0001f,
...
Test(RoundRobin, 5proc_rr, .disabled=false) {
  SCHEDULER_STATS* stats = get_empty_stats_block();
  SCHEDULER_PARAMS params = (SCHEDULER_PARAMS) {
    .preemptable = true,
    .time_quantum = 0.0001f,
